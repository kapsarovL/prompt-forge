              ...
              {feedbackSubmitted ? (
                ...
                <div className="space-y-8">
                  ...
                  <textarea
                    ...
                    className="w-full h-32 bg-black/40 border border-white/10 rounded-3xl p-5 text-sm text-white placeholder-zinc-700 focus:outline-none focus:border-indigo-500/50 transition-all resize-none font-light"
                  />
